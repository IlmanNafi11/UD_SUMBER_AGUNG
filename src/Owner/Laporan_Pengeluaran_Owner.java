...
public class Laporan_Pengeluaran_Owner extends javax.swing.JFrame {

    public Laporan_Pengeluaran_Owner() {
        initComponents();
        TableLaporan();
    }
    ...
    private void initComponents() {
        ...
        txtCari.setText("Tanggal Laporan");
        ...
        if (tblLapPengeluaran.getColumnModel().getColumnCount() > 0) {
            tblLapPengeluaran.getColumnModel().getColumn(0).setResizable(false);
            tblLapPengeluaran.getColumnModel().getColumn(1).setResizable(false);
            tblLapPengeluaran.getColumnModel().getColumn(2).setResizable(false);
            tblLapPengeluaran.getColumnModel().getColumn(3).setResizable(false);
        }

        getContentPane().add(jScrollPanetblLapPengeluaran, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 250, 970, 660));

        lblBackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Laporan Admin owner.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Laporan_Pengeluaran_Owner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Laporan_Pengeluaran_Owner().setVisible(true);
            }
        });
    }
