...
public class Penyewa_Owner extends javax.swing.JFrame {

    public Penyewa_Owner() {
        initComponents();
        TablePenyewa();
    }
    ...
    private void initComponents() {
        ...
        LblBackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Penyewa owner.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Penyewa_Owner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Penyewa_Owner().setVisible(true);
            }
        });
    }
