...
public class Stock_Owner extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblStokAlat.setFocusable(false);
        tblStokAlat.setGridColor(new java.awt.Color(34, 170, 170));
        tblStokAlat.setRequestFocusEnabled(false);
        ...
        if (tblStokAlat.getColumnModel().getColumnCount() > 0) {
            tblStokAlat.getColumnModel().getColumn(0).setResizable(false);
            tblStokAlat.getColumnModel().getColumn(1).setResizable(false);
            tblStokAlat.getColumnModel().getColumn(2).setResizable(false);
            tblStokAlat.getColumnModel().getColumn(3).setResizable(false);
        }
        ...
        jScrollPaneTblMainten.setFocusable(false);
        jScrollPaneTblMainten.setRequestFocusEnabled(false);
        ...
        tblMainten.setFocusable(false);
        tblMainten.setGridColor(new java.awt.Color(34, 170, 170));
        tblMainten.setRequestFocusEnabled(false);
        ...
        LabelBackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Stock owner.png"))); // NOI18N
    ...
    private void btnUbahMaintenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahMaintenActionPerformed
        ...
        try {
            ...
            if (!nama_alat.isEmpty() && nama_alat.length() <= 25 && nama_alat.matches("[a-zA-Z ]+") && jumlah <= cekStok && !admin.isEmpty() && !Status.isEmpty()) {
                String sql = "UPDATE daftar_perawatan SET nama_alat = '" + nama_alat + "', jumlah = '" + jumlah + "', nama_admin = '" + namaAdmin + "', status = '" + Status + "', "
                        + "no_ktp_admin = '" + Ktp_Admin + "', id_alat = '" + id_alat + "' WHERE id_permintaan = '"+id_permintaan+"'";
                if (JOptionPane.showConfirmDialog(null, "Simpan perubahan ? \n"
                        + "Nama alat = " + nama_alat + "\n"
                        + "Jumlah = " + jumlah + "\n"
                        + "Status = " + Status + "\n"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Stock_Owner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Stock_Owner().setVisible(true);
            }
        });
    }
