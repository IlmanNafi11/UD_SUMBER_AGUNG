...
public class Transaksi_Sewa_Owner extends javax.swing.JFrame {

    public Transaksi_Sewa_Owner() {
        initComponents();
        tabelTransSewa();
    }
    ...
    private void initComponents() {
        ...
        lblBackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Transaksi Sewa owner.png"))); // NOI18N
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Transaksi Gagal " + e, "Kesalahan", JOptionPane.ERROR_MESSAGE, error);
        }
        tabelTransSewa();
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        ...
        try {
            ...
            if (TanggalAwal != null && TanggalAkhir != null && !nama_alat.isEmpty() && !nama_admin.isEmpty() && !no_ktp_penyewa.isEmpty() && jumlah_sewa <= 100) {
                ...
                Connection koneksi = ClassKoneksi.GetConnection();
                Statement st = koneksi.createStatement();
                String sql = "UPDATE transaksi_menyewa SET nama_alat = '" + nama_alat + "', awal_sewa = '" + awal_Sewa + "', akhir_sewa = '" + akhir_Sewa + "', jumlah = '" + jumlah_sewa + "', no_ktp_penyewa = '" + ktp_Penyewa + "',"
                        + " nama_admin = '" + nama_admin + "', biaya_sewa = '" + biaya_sewa + "', id_alat = '" + id_alat + "', ktp_owner = '" + ktp_owner + "' WHERE id_transaksi = '" + id_transaksi + "'";
    ...
    private void lblCariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblCariMouseClicked
        try {
            ...
            if (!CariTransaksi.isEmpty()) {
                ...
                DefaultTableModel tblDBTransSewa = new DefaultTableModel();
                tblDBTransSewa.addColumn("ID Transaksi");
                tblDBTransSewa.addColumn("Nama Alat");
                tblDBTransSewa.addColumn("Awal Sewa");
                tblDBTransSewa.addColumn("Akhir Sewa");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Transaksi_Sewa_Owner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Transaksi_Sewa_Owner().setVisible(true);
            }
        });
    }
