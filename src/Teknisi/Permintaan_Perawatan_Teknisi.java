...
public class Permintaan_Perawatan_Teknisi extends javax.swing.JFrame {

    public Permintaan_Perawatan_Teknisi() {
        initComponents();
        TabelDataMainten();
    }
    ...
    public void TabelDataMainten() {
        DefaultTableModel TblDbMainten = new DefaultTableModel();
        ...
        try {
            ...
            for (int i = 0; i < TblPermintaanMainten.getColumnCount(); i++) {
                TableColumn kolom = TblPermintaanMainten.getColumnModel().getColumn(i);
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblPermintaanPerawatan, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 176, 320, 60));
        ...
        getContentPane().add(lblTransPerawatan, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 265, 320, 60));
        ...
        lblBackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Permintaan Perawatan teknisi.png"))); // NOI18N
    ...
    private void btnUbahStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahStatusActionPerformed
        ...
        String id_req = TblPermintaanMainten.getValueAt(pilih_baris, 0).toString();
        try {
            Connection koneksi = ClassKoneksi.GetConnection();
            Statement st = koneksi.createStatement();
            String sql = "UPDATE daftar_perawatan SET status = '" + status + "' WHERE id_permintaan = '"+id_req+"'";
    ...
    private void lblTransPerawatanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblTransPerawatanMouseClicked
        Transaksi_Maintenance_Teknisi pgTransMaiten = new Transaksi_Maintenance_Teknisi();
        pgTransMaiten.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Permintaan_Perawatan_Teknisi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Permintaan_Perawatan_Teknisi().setVisible(true);
            }
        });
    }
