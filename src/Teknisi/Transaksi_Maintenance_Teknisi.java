...
public class Transaksi_Maintenance_Teknisi extends javax.swing.JFrame {

    public Transaksi_Maintenance_Teknisi() {
        initComponents();
        tabelTransMainten();
    }
    ...
    public void tabelTransMainten() {
        DefaultTableModel tblDBTransMainten = new DefaultTableModel();
    ...
    private void initComponents() {
        ...
        lbPermintaanPerawatan = new javax.swing.JLabel();
        lblTransaksiPerawatan = new javax.swing.JLabel();
        ...
        getContentPane().add(btnKembali, new org.netbeans.lib.awtextra.AbsoluteConstraints(1275, 926, 94, 40));

        lbPermintaanPerawatan.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lbPermintaanPerawatanMouseClicked(evt);
            }
        });
        getContentPane().add(lbPermintaanPerawatan, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 176, 320, 60));

        lblTransaksiPerawatan.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                lblTransaksiPerawatanMouseClicked(evt);
            }
        });
        getContentPane().add(lblTransaksiPerawatan, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 265, 320, 60));
        ...
        LblBackground.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Transaksi Maintenance Teknisi.png"))); // NOI18N
    ...
    private void lbPermintaanPerawatanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbPermintaanPerawatanMouseClicked
        Permintaan_Perawatan_Teknisi pgRequest = new Permintaan_Perawatan_Teknisi();
        pgRequest.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_lbPermintaanPerawatanMouseClicked

    private void lblTransaksiPerawatanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblTransaksiPerawatanMouseClicked

    }//GEN-LAST:event_lblTransaksiPerawatanMouseClicked
    ...
    private void lblCariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblCariMouseClicked
        try {
            ...
            if (!CariTransaksi.isEmpty()) {
                ...
                tblTransPerawatan.getTableHeader().setPreferredSize(new Dimension(0, 40));
                tblTransPerawatan.setOpaque(false);
                ((DefaultTableCellRenderer) tblTransPerawatan.getDefaultRenderer(Object.class)).setOpaque(false);
                jScrollPaneTblTransMainten.getViewport().setOpaque(false);
                if (rs.next()) {
                    tblDBTransMainten.addRow(new Object[]{
                        rs.getString("id_perawatan"),
    ...
    private void isiTextFieldTransMainten(int row) {
        ...
        if (pilih_baris >= 0) {
            try {
                ...
                JOptionPane.showMessageDialog(null, "Gagal mengambil data ", "Kesalahan", JOptionPane.ERROR_MESSAGE, error);
            }
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Transaksi_Maintenance_Teknisi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Transaksi_Maintenance_Teknisi().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lbPermintaanPerawatan;
    private javax.swing.JLabel lblCari;
    private javax.swing.JLabel lblKeluar;
    private javax.swing.JLabel lblTransaksiPerawatan;
